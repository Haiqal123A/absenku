    ...
    <div className="min-h-screen bg-[#F4F8FC]">
      ...
      <main className="mx-auto max-w-7xl px-4 pb-24 pt-7 sm:px-6 lg:px-8 lg:pb-10 lg:pt-9">
        ...
        <section className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm leading-6 text-slate-500">
              Pantau rekapitulasi dan riwayat kehadiran kamu selama periode yang
              dipilih.
            </p>
          </div>
              ...
              <div className="relative h-16 w-16 shrink-0">
                <svg className="h-16 w-16 -rotate-90" viewBox="0 0 64 64">
                  ...
                  <circle
                    ...
                    strokeDashoffset={
                      163.36 - (163.36 * summary.persentase) / 100
                    }
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-blue-50">
                      <CalendarDays size={17} className="text-[#073BBA]" />
                    </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs leading-5 text-slate-500">
                Data yang ditampilkan saat ini merupakan data sementara untuk
                kebutuhan pengembangan sistem. Setelah API terhubung, laporan
                akan otomatis menggunakan data presensi yang tersimpan di
                database.
              </p>
            </div>
          </div>
        ...
        <div className="mt-6 flex items-center justify-between border-t border-slate-200 pt-5">
          <p className="text-xs text-slate-400">Absenku · Laporan Kehadiran</p>
