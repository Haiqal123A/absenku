            ...
            <div className="relative z-10 flex flex-col justify-between w-full">
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-xl bg-[#FFD21A] flex items-center justify-center">
                  <span className="text-[#073BBA] text-xl font-black">A</span>
                </div>

                <div>
                  <h1 className="text-2xl font-black text-white">ABSENKU</h1>
              ...
              <div className="my-auto py-16">
                ...
                <p className="text-blue-100 mt-5 leading-7 max-w-md">
                  Catat presensi masuk dan pulang, pantau riwayat kehadiran,
                  ajukan izin, dan lihat laporan presensi Anda dalam satu
                  platform.
                </p>
              </div>
          ...
          <div className="p-7 sm:p-10 lg:p-12">
            ...
            <div className="flex lg:hidden items-center gap-3 mb-10">
              <div className="w-11 h-11 rounded-xl bg-[#073BBA] flex items-center justify-center">
                <span className="text-[#FFD21A] font-black text-lg">A</span>
              </div>

              <div>
                <h1 className="text-xl font-black text-[#073BBA]">ABSENKU</h1>
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-slate-500 mt-2">
                Silakan masuk untuk mengakses dashboard presensi Anda.
              </p>
            </div>
            ...
            <div className="mt-6 bg-yellow-50 border border-yellow-100 rounded-xl p-4">
              <p className="text-xs font-bold text-yellow-700">Akun Demo</p>
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 text-center">
              <p className="text-xs text-slate-400">Sistem Presensi Digital</p>

              <p className="text-xs font-bold text-[#073BBA] mt-1">ABSENKU</p>
            </div>
          </div>
        </div>
      </div>
