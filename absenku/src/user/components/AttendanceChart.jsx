    ...
    <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <BarChart3 size={22} className="text-[#073BBA]" />

          <h2 className="font-bold text-[#073BBA]">Grafik Kehadiran</h2>
        </div>
        ...
        <div className="flex items-center bg-blue-50 rounded-full p-1 text-xs">
          ...
          <button className="px-4 py-2 text-[#073BBA]">30 Hari</button>

          <button className="px-4 py-2 text-[#073BBA]">1 Tahun</button>
        </div>
      </div>
