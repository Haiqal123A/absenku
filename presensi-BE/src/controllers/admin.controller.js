...
async function getTodayAttendance(req, res, next) {
  try {
    ...
    return successResponse(
      res,
      "Data presensi hari ini berhasil dimuat.",
      result,
      200,
    );
  } catch (error) {
...
async function getAllAttendanceHistory(req, res, next) {
  try {
    ...
    return successResponse(
      res,
      "Seluruh riwayat presensi berhasil dimuat.",
      result,
      200,
    );
  } catch (error) {
...
async function getAllStudents(req, res, next) {
  try {
    ...
    return successResponse(
      res,
      "Daftar siswa PKL berhasil dimuat.",
      {
...
async function createStudent(req, res, next) {
  try {
    ...
    return successResponse(
      res,
      "Akun siswa PKL berhasil didaftarkan.",
      result,
      201,
    );
  } catch (error) {
 ...
 * Menampilkan statistik presensi siswa hari ini
 */
async function getAttendanceStats(req, res, next) {
  try {
    const result = await adminService.getAttendanceStats();

    return successResponse(
      res,
      "Statistik presensi berhasil dimuat.",
      result,
      200,
    );
  } catch (error) {
