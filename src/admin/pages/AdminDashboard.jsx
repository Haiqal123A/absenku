...
export default function AdminDashboard() {
   ...
   * ============================================================
   * TANGGAL HARI INI
   * Otomatis mengikuti tanggal komputer/browser.
   * Tidak ada lagi tanggal hardcode.
   * ============================================================
   */
  ...
  const hadir = students.filter((item) =>
  ...
  /*
   * ============================================================
   * DATA TABEL KEHADIRAN
   * ============================================================
   */

  const attendance = students.map((student) => ({
    ...getAttendance(
      getDisplayAttendance(student, settings)
    ),
      ...
      <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-5">
        ...
        {stats.map((item) => (
          ...
          >
            ...
            <p
              className={`mt-2 text-3xl font-extrabold ${item.color}`}
            >
              {item.value}
            </p>
