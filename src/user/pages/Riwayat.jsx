...
const dummyRecords = [
  {
    ...
    longitude: 106.7942,
    accuracy: 8,
    note: "Presensi masuk kantor",
    wfh_activity: null,
    created_at: "2026-09-07T07:48:21",
  },
  {
    id: "ATT-002",
    user_id: "user-001",
    ...
    longitude: null,
    accuracy: null,
    note: "Melaksanakan pekerjaan dari rumah",
    wfh_activity: {
      pekerjaan:
        "Mengerjakan halaman dashboard user dan memperbaiki tampilan responsive.",
      hasil:
        "Dashboard user sudah selesai dan tampilan mobile sudah diperbaiki.",
      progress: 80,
      kendala:
        "Beberapa bagian API masih menunggu endpoint dari backend.",
    },
    created_at: "2026-09-05T08:01:14",
  },
];
...
function Riwayat() {
  const [records, setRecords] = useState(() => {
    try {
      ...
      return saved.length > 0 ? saved : dummyRecords;
    } catch {
      return dummyRecords;
    }
  });
    ...
    <div className="min-h-screen bg-[#f4f8fc] pb-24 lg:pb-8">
      ...
      <main className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm font-semibold text-[#073BBA] mb-1">
            PRESENSI
          </p>
            ...
            <div className="p-5 sm:p-6 space-y-5">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-bold text-[#0B2875]">
                    Foto Presensi
                  </h3>
                </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-purple-500 mt-0.5">
                            Aktivitas yang dikirim bersamaan
                            dengan presensi
                          </p>
                        </div>
                      </div>
