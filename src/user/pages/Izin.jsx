...
const STORAGE_KEY = "absenku_izin_records";
...
function Izin() {
  ...
  const izinRemaining = Math.max(
    MAX_IZIN_PER_MONTH - izinUsed,
    0
  );

  const izinLimitReached =
    izinRemaining <= 0;

  const progressWidth = Math.min(
    (izinUsed / MAX_IZIN_PER_MONTH) * 100,
    100
  );
  ...
  const handleSubmit = async (event) => {
    ...
    try {
       ...
       * =====================================================
       *
       * Nanti ketika backend sudah tersedia:
       *
       ...
       * });
       *
       * Backend sebaiknya tetap melakukan validasi
       * maksimal 4 izin per bulan.
       */
      ...
      <main className="mx-auto max-w-7xl px-4 pb-24 pt-7 sm:px-6 lg:px-8 lg:pb-10 lg:pt-9">
        ...
        <section>
          ...
          <p className="mt-2 max-w-xl text-sm leading-6 text-slate-500">
            Ajukan izin atau sakit untuk mencatat
            ketidakhadiran kamu pada sistem.
          </p>
        </section>
            ...
            <div className="mt-5 flex items-start gap-3 rounded-xl border border-red-100 bg-red-50 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-5 text-red-600/80">
                  Kamu sudah menggunakan seluruh kuota
                  izin bulan ini. Pengajuan izin baru
                  dapat dilakukan kembali pada bulan
                  berikutnya.
                </p>
              </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
              ...
              <div className="mt-5 space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-xs leading-5 text-slate-500">
                    Kuota akan otomatis kembali pada
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-xs leading-5 text-slate-500">
                    Pengajuan sakit tidak mengurangi
                    kuota izin.
                  </p>
